...
function create_shipment($shipment_id, $sender, $reciever, $eta, $est_cost, $express) {
	$sql_query = "INSERT INTOINTOINTO shipment  (tracknumber, from_cl_id, to_cl_id, from_store, to_store,  express, est_cost, eta) VALUES( :shipment_id, :sender, :reciever, :this_ls_id, :ls_destination, :express, :est_cost, :eta)";
